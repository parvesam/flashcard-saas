    ...
    <Container maxWidth={false} sx={{ px: 2 }}>
      ...
      <Typography variant="h4" gutterBottom>
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{p: 3, border: '1px solid',borderColor: 'grey.300', borderRadius: 2,}}>
            <Typography variant="h5" gutterBottom>Advanced Pro</Typography>
            <Typography variant="h6" gutterBottom>$20/Month</Typography>
            <Typography gutterBottom>Unlimited flashcards, storage and 5 practice quizzes.</Typography>
            <Button variant = "contained" color = "primary" sx={{mt: 2}}>Choose Advanced Pro</Button>
            </Box>
          </Grid>
        </Grid>
      </Box>
