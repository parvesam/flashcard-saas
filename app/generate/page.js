...
import{Container, Box, Typography, Paper, TextField, Button, CardActionArea, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText} from '@mui/material'
    ...
    return <Container maxWidth="md">
        ...
        <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
                ...
                Type = 'text' fullWidth value={name} onChange={(e)=>setName(e.target.value)} variant="outlined" />
            </DialogContent>
            <DialogActions>
